        ...
        <div className="flex flex-wrap justify-center">
          <div className="flex">
            <div className="hover:scale-110">
              <img src="/works.jpg" alt="Project 1" className="w-1/2 min-h-[15vh] sm:min-h-[25vh] min-w-[25vw] sm:w-1/4 md:w-1/5 lg:w-1/6 xl:w-1/8 h-auto my-4 sm:mx-2 rounded-2xl" />
            ...
            <div className="hover:scale-110">
              <img src="/works.jpg" alt="Project 2" className="w-1/2 min-h-[15vh] sm:min-h-[25vh] min-w-[25vw] sm:w-1/4 md:w-1/5 lg:w-1/6 xl:w-1/8 h-auto my-4 sm:mx-2 rounded-2xl" />
            ...
            <div className="hover:scale-110">
              <img src="/works.jpg" alt="Project 3" className="w-1/2 min-h-[15vh] sm:min-h-[25vh] min-w-[25vw] sm:w-1/4 md:w-1/5 lg:w-1/6 xl:w-1/8 h-auto my-4 sm:mx-2 rounded-2xl" />
